...
Trực quan hóa topo và dòng dữ liệu & Hạn chế & Khá & Tốt \\ \hline
Tích hợp học sâu hỗ trợ phân tích & Không hỗ trợ & Tốt & Khá \\ \hline
...
\end{enumerate} \\ \hline
\textbf{Luồng thay thế và ngoại lệ} & \hspace{0.35em}\parbox[t]{\dimexpr\linewidth-1em\relax}{\raggedright 2a. Nếu không truy cập được giao diện đã chọn hoặc không thể khởi tạo phiên bắt gói, hệ thống hiển thị lỗi và dừng thao tác.\par 2b. Nếu biểu thức bộ lọc không hợp lệ thì hệ thống thông báo lỗi và yêu cầu người dùng chỉnh lại trước khi bắt đầu.\par 2c. Nếu vùng hiển thị bị thu hẹp do nội dung quá dài, hệ thống tự động ngắt dòng để tránh chữ chạm viền bảng.} \\ \hline
...
\end{enumerate} \\ \hline
\textbf{Luồng thay thế và ngoại lệ} & \hspace{0.35em}\parbox[t]{\dimexpr\linewidth-1.4em\relax}{\raggedright 2a. Nếu không có gói tin hợp lệ để thống kê thì hệ thống thông báo và không tạo bảng kết quả.\par 6a. Người dùng có thể xuất bảng hiện tại ra tệp CSV khi cần lưu trữ hoặc báo cáo.\par 7a. Người dùng có thể chuyển các góc nhìn thống kê khác.} \\ \hline
\textbf{Hậu điều kiện} & \hspace{0.35em}\parbox[t]{\dimexpr\linewidth-1.4em\relax}{\raggedright Các bảng thống kê hội thoại, đầu cuối hoặc phân cấp giao thức đã được tạo và hiển thị; người dùng có thể tiếp tục đối chiếu, lọc sâu hơn hoặc xuất ra tệp CSV.} \\ \hline
\end{longtable}
